...
namespace bazar
{
	public partial class reference
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget bazar.reference
			this.UIManager = new global::Gtk.UIManager ();
			global::Gtk.ActionGroup w1 = new global::Gtk.ActionGroup ("Default");
			this.addAction = new global::Gtk.Action ("addAction", "_Добавить", "Новый элемент справочника", "gtk-add");
			this.addAction.ShortLabel = "_Добавить";
			w1.Add (this.addAction, null);
			this.editAction = new global::Gtk.Action ("editAction", "_Изменить", "Редактирование элемента справочника", "gtk-edit");
			this.editAction.ShortLabel = "_Изменить";
			w1.Add (this.editAction, null);
			this.removeAction = new global::Gtk.Action ("removeAction", "_Удалить", null, "gtk-remove");
			this.removeAction.ShortLabel = "_Удалить";
			w1.Add (this.removeAction, null);
			this.UIManager.InsertActionGroup (w1, 0);
			this.AddAccelGroup (this.UIManager.AccelGroup);
			this.Name = "bazar.reference";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child bazar.reference.VBox
			...
			this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='addAction' action='addAction'/><toolitem name='editAction' action='editAction'/><toolitem name='removeAction' action='removeAction'/></toolbar></ui>");
			...
			this.label1.LabelProp = "Быстрый поиск по имени:";
			...
			w18.Position = 0;
			// Internal child bazar.reference.ActionArea
			...
			w31.Pixbuf = global::Stetic.IconLoader.LoadIcon (this, "gtk-cancel", global::Gtk.IconSize.Button);
			w30.Add (w31);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w40.Pixbuf = global::Stetic.IconLoader.LoadIcon (this, "gtk-ok", global::Gtk.IconSize.Button);
			w39.Add (w40);
			// Container child GtkHBox.Gtk.Container+ContainerChild
