...
START TRANSACTION;
USE `bazar`;
INSERT INTO `bazar`.`cash` (`id`, `name`, `color`) VALUES (NULL, 'Наличная касса', NULL);
...
INSERT INTO `bazar`.`base_parameters` (`name`, `str_value`) VALUES ('version', '2.2');
