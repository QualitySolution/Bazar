...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `active_contracts` (`id` INT, `number` INT, `lessee_id` INT, `org_id` INT, `place_type_id` INT, `place_no` INT, `sign_date` INT, `start_date` INT, `end_date` INT, `pay_day` INT, `cancel_date` INT, `comments` INT);
...
START TRANSACTION;
USE `bazar`;
INSERT INTO `organizations` (`id`, `name`) VALUES (DEFAULT, 'Моя организация');
...
START TRANSACTION;
USE `bazar`;
INSERT INTO `units` (`id`, `name`) VALUES (DEFAULT, 'усл.');
INSERT INTO `units` (`id`, `name`) VALUES (DEFAULT, 'шт.');
INSERT INTO `units` (`id`, `name`) VALUES (DEFAULT, 'кв. м.');
INSERT INTO `units` (`id`, `name`) VALUES (DEFAULT, 'кВт');
...
START TRANSACTION;
USE `bazar`;
INSERT INTO `services` (`id`, `name`, `units_id`, `income_id`, `by_area`, `incomplete_month`, `service_provider_id`) VALUES (DEFAULT, 'Аренда', 3, 1, TRUE, FALSE, NULL);
INSERT INTO `services` (`id`, `name`, `units_id`, `income_id`, `by_area`, `incomplete_month`, `service_provider_id`) VALUES (DEFAULT, 'Электричество', 4, 2, FALSE, FALSE, NULL);
...
START TRANSACTION;
USE `bazar`;
INSERT INTO `meter_types` (`id`, `name`) VALUES (DEFAULT, 'Эл. однотарифный');
