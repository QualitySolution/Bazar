...
{
	public partial class MeterReadingDlg
	{
		...
		protected virtual void Build()
		{
			...
			// Widget Bazar.Dialogs.Estate.MeterReadingDlg
			this.Name = "Bazar.Dialogs.Estate.MeterReadingDlg";
			this.Title = global::Mono.Unix.Catalog.GetString("Показания счетчика");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child Bazar.Dialogs.Estate.MeterReadingDlg.VBox
			...
			this.dateReading.WithTime = false;
			...
			this.spinValue = new global::Gtk.SpinButton(0D, 10000000D, 1D);
			this.spinValue.CanFocus = true;
			this.spinValue.Name = "spinValue";
			this.spinValue.Adjustment.PageIncrement = 10D;
			this.spinValue.ClimbRate = 1D;
			...
			w10.Expand = false;
			w10.Fill = false;
			// Internal child Bazar.Dialogs.Estate.MeterReadingDlg.ActionArea
